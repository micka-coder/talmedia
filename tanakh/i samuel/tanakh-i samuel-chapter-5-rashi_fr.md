...
### passuk 6
<b>Et il les dévasta.</b> Expression [<span>שְׁמָמָה</span>] signifiant désolation.
...
### passuk 9
<b>Et ils étaient affligés intérieurement. </b><span>וַיִשָֹּתְרוּ</span> est identique à <span>וַיִסָּתְרוּ</span> car il est répertorié dans la Masora parmi les mots écrits... avec un '<span>שֹ</span>' et expliqués comme s'ils étaient écrits avec un '<span>ס</span>' signifiant "il y avait une plaie dans les parties cachées du corps. "<sup>2</sup><i class="footnote">Ou bien cela peut signifier que la peste s'est produite la nuit lorsqu'il faisait sombre et qu'ils ne pouvaient pas voir le <span>שְׁרָצִים</span>, c'est-à-dire, la peste leur a été cachée. -Da'as Sofrim</i>
